...
class DataModel:
    ...
    def __init__(
        ...
        *,
        ...
        self.state = state
        self.excluded_track_metrics = excluded_track_metrics or set()
    ...
    def analysis_df(self) -> pl.DataFrame:
        ...
        return aggregate_tracks(
            ...
            methods=list(self.state.track_agg_methods),
    ...
    def numeric_features(self) -> list[str]:
        ...
        return [
            ...
            if column != self.state.track_id_col and dtype.is_numeric()
        ]
